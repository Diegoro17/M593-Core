...
const QString RAVEN_IPC_PREFIX("m593:");
// BIP70 payment protocol messages
const char* BIP70_MESSAGE_PAYMENTACK = "PaymentACK";
const char* BIP70_MESSAGE_PAYMENTREQUEST = "PaymentRequest";
// BIP71 payment protocol media types
const char* BIP71_MIMETYPE_PAYMENT = "application/m593-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/m593-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/m593-paymentrequest";
