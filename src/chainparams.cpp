...
public:
    CMainParams() {
        strNetworkID = "main";
        consensus.nSubsidyHalvingInterval = 2000000;  //~ 3.8 yrs at 1 min block time
        consensus.nBIP34Enabled = true;
        consensus.nBIP65Enabled = true; // 000000000000000004c2b624ed5d7756c508d90fd0da2c7c679febfa6c4735f0
        consensus.nBIP66Enabled = true;
        consensus.nSegwitEnabled = true;
        consensus.nCSVEnabled = true;
        // Development-chain limit. This intentionally keeps local CPU mining
        // fast enough to exercise rewards, transfers and assets before launch.
        ...
        // Provisional M593 BIP44 coin type; registration is required before release.
        nExtCoinType = 593;
...
//        /////////////////////////////////////////////////////////////////
        ...
        // M593 testnet DNS seeds will be added after bootstrap nodes exist.
        vSeeds.clear();
